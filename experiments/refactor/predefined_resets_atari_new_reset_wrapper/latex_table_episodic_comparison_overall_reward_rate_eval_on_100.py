...
for match in data_matches:
    for match in data_matches:
        ...
        data[algo][task] = (
            ...
            float(eps_rwd_10_val) * 100,
            float(eps_rwd_10_ste) * 100,
            float(eps_rwd_100_val) * 100,
            float(eps_rwd_100_ste) * 100,
            float(eps_rwd_1000_val) * 100,
            float(eps_rwd_1000_ste) * 100,
        )
        ...
        for algo in algorithms:
            if task in my_data[algo]:
                ...
                tmp = [
                    ...
                    (eps_rwd_100_val, eps_rwd_100_ste),
                ]
