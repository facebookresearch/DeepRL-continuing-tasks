...
data_file = "/home/yiwan/pearl_execution/pearl/experiments/refactor/predefined_resets_mujoco_new_reset_wrapper/plot_compare_reset_costs_reward_rate.txt"
...
for match in data_matches:
    ...
    data[algo][task] = (
        float(rwd_10_val_eval_10),
        float(rwd_10_ste_eval_10),
        float(rwd_100_val_eval_10),
        float(rwd_100_ste_eval_10),
        float(rwd_1000_val_eval_10),
        float(rwd_1000_ste_eval_10),
        float(rwd_10_val_eval_100),
        float(rwd_10_ste_eval_100),
        float(rwd_100_val_eval_100),
        float(rwd_100_ste_eval_100),
        float(rwd_1000_val_eval_100),
        float(rwd_1000_ste_eval_100),
        float(rwd_10_val_eval_1000),
        float(rwd_10_ste_eval_1000),
        float(rwd_100_val_eval_1000),
        float(rwd_100_ste_eval_1000),
        float(rwd_1000_val_eval_1000),
        float(rwd_1000_ste_eval_1000),
    )
