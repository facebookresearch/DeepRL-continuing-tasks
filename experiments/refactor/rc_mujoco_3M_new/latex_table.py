...
def generate_latex_table(data, only_TD=False):
    ...
    if only_TD:
        ...
        latex_code += (
            r"\caption{Performance improvement when applying reward centering to the tested algorithms to solve the Mujoco testbed. Here, RVI standards for the reference-state-based approach. MA standards for the moving-average-based approach.} " + "\n"
        )
