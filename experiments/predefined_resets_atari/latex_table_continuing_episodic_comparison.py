...
for match in reward_rate_matches:
    ...
    reward_rate_data[algo][task] = (
        float(continuing_val) * 100,  # multiply by 100 for better readability
        float(continuing_ste) * 100,
        float(episodic_val) * 100,
        float(episodic_ste) * 100,
    )

num_resets_data = {"dqn": {}, "sac": {}, "ppo": {}}
